...
public class PositiveNumbersGt25Roa {

    private List<String> tickersList;

    public PositiveNumbersGt25Roa() {
        ...
        try {
            firstScreen = Jsoup
                    .connect("https://finviz.com/screener.ashx?v=111&f=fa_curratio_o1,fa_debteq_u1,fa_eps5years_pos,fa_epsqoq_pos,fa_epsyoy_pos,fa_grossmargin_pos,fa_ltdebteq_u1,fa_netmargin_pos,fa_opermargin_pos,fa_pe_profitable,fa_roa_o25,fa_roe_pos,fa_roi_pos,fa_sales5years_pos,fa_salesqoq_pos,sh_price_o10&ft=4")
                    .get();
    ...
    private static void printPositiveComapniesList() {
        ...
        PositiveNumbersGt25Roa highRoaLowPEScreenResult = new PositiveNumbersGt25Roa();
