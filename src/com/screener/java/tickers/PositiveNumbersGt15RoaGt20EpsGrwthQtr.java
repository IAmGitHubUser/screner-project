...
public class PositiveNumbersGt15RoaGt20EpsGrwthQtr {

    private List<String> tickersList;

    public PositiveNumbersGt15RoaGt20EpsGrwthQtr() {
        ...
        try {
            firstScreen = Jsoup
                    .connect("https://finviz.com/screener.ashx?v=111&f=fa_curratio_o1,fa_debteq_u1,fa_eps5years_pos,fa_epsqoq_o20,fa_epsyoy_pos,fa_grossmargin_pos,fa_ltdebteq_u1,fa_netmargin_pos,fa_opermargin_pos,fa_pe_profitable,fa_roa_pos,fa_roe_o15,fa_roi_pos,fa_sales5years_pos,fa_salesqoq_pos,sh_price_o10&ft=4")
                    .get();
        ...
        for (int tabNumber = 2; tabNumber <= totalTabRoundUpInt; tabNumber++) {
            ...
            //below url is for second tab, but without last two chara in it
            try {
                secondScreen = Jsoup
                        .connect("https://finviz.com/screener.ashx?v=111&f=fa_curratio_o1,fa_debteq_u1,fa_eps5years_pos,fa_epsqoq_o20,fa_epsyoy_pos,fa_grossmargin_pos,fa_ltdebteq_u1,fa_netmargin_pos,fa_opermargin_pos,fa_pe_profitable,fa_roa_pos,fa_roe_o15,fa_roi_pos,fa_sales5years_pos,fa_salesqoq_pos,sh_price_o10&ft=4&r="
    ...
    private static void printPositiveComapniesList() {
        ...
        PositiveNumbersGt15RoaGt20EpsGrwthQtr highRoaLowPEScreenResult = new PositiveNumbersGt15RoaGt20EpsGrwthQtr();
