...
public class MyHashMap {
    ...
    private void buildMap(Elements elements, Elements percentileElement, Elements tickerElement) {
        ...
        map.put("bookValueGrowthLastFiveYearsPercentile", Fidelity.getPercentileElement(percentileElement, 60, false));
        map.put("cashFlowGrowthLastFiveYearsPercentile", Fidelity.getPercentileElement(percentileElement, 66, false));
        map.put("currentRatio", finviz.getCharacteristic(elements, 50, false));
        map.put("currentRatioPercentile", Fidelity.getPercentileElement(percentileElement, 135, false));
        ...
        map.put("debtToCapitalPercentileReverse", Fidelity.getPercentileElement(percentileElement, 141, true));
        map.put("debtToEquity", finviz.getCharacteristic(elements, 56, false));
        map.put("debtToEquityQtrPercentileReverse", Fidelity.getPercentileElement(percentileElement, 129, true));
        map.put("debtToEquityTtmPercentileReverse", Fidelity.getPercentileElement(percentileElement, 132, true));
        map.put("dividendYield", finviz.getCharacteristic(elements, 43, true));
        map.put("ebitdMarginPercentile", Fidelity.getPercentileElement(percentileElement, 75, false));
        map.put("grossMargin", finviz.getCharacteristic(elements, 46, true));
        map.put("grossMarginQtrPercentile", Fidelity.getPercentileElement(percentileElement, 69, false));
        map.put("grossMarginPercentile", Fidelity.getPercentileElement(percentileElement, 72, false));
        map.put("longTermDebtToAssetsLastQtrPercentileReverse", Fidelity.getPercentileElement(percentileElement, 117, true));
        map.put("longTermDebtToAssetsTtmPercentileReverse", Fidelity.getPercentileElement(percentileElement, 120, true));
        map.put("longTermDebtToCapitalLastQtrPercentileReverse", Fidelity.getPercentileElement(percentileElement, 123, true));
        map.put("longTermDebtToCapitalTtmPercentileReverse", Fidelity.getPercentileElement(percentileElement, 126, true));
        map.put("longTermDebtToEquity", finviz.getCharacteristic(elements, 62, false));
        map.put("longTermDebtToEquityLastQtrPercentileReverse", Fidelity.getPercentileElement(percentileElement, 111, true));
        map.put("longTermDebtToEquityTtmPercentileReverse", Fidelity.getPercentileElement(percentileElement, 114, true));
        ...
        map.put("operationMarginQtrPercentile", Fidelity.getPercentileElement(percentileElement, 81, false));
        map.put("operationMargingPercentile", Fidelity.getPercentileElement(percentileElement, 84, false));
        ...
        map.put("pretaxMargingPercentile", Fidelity.getPercentileElement(percentileElement, 90, false));
        ...
        map.put("profitMarginQtrPercentile", Fidelity.getPercentileElement(percentileElement, 78, false));
        map.put("returnOnAsset", finviz.getCharacteristic(elements, 28, true));
        map.put("returnOnAssetFromfidelity", Fidelity.getTickerElements(tickerElement, 34));
        map.put("returnOnAssetsLastQtrPercentile", Fidelity.getPercentileElement(percentileElement, 99, false));
        map.put("returnOnAssetsPercentile", Fidelity.getPercentileElement(percentileElement, 102, false));
        map.put("returnOnEquity", finviz.getCharacteristic(elements, 34, true));
        map.put("returnOnEquityLastQtrPercentile", Fidelity.getPercentileElement(percentileElement, 93, false));
        map.put("returnOnEquityPercentile", Fidelity.getPercentileElement(percentileElement, 96, false));
        map.put("returnOnInvestmentLastQtrPercentile", Fidelity.getPercentileElement(percentileElement, 105, false));
        map.put("returnOnInvestmentTtmPercentile", Fidelity.getPercentileElement(percentileElement, 108, false));
        map.put("returnOnInvestment", finviz.getCharacteristic(elements, 40, true));
        
        // Following two are not available in Fidelity anymore
        ...
        // Above two are not available in Fidelity anymore
