...
public class CompaniesWithPositiveNumbers {

    private List<String> tickersList;

    public CompaniesWithPositiveNumbers() {
    ...
    private static void printPositiveComapniesList() {
        ...
        CompaniesWithPositiveNumbers highRoaLowPEScreenResult = new CompaniesWithPositiveNumbers();
